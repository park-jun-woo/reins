...
//ff:what OpenAICompat — OpenAI 호환 chat completions endpoint(xai 등)용 Backend. URL·Backend(키 조회용 env 이름)·Model을 갖는다. Backend가 API 키 env var 이름을 가리킨다(예: "xai" ⇒ XAI_API_KEY).
