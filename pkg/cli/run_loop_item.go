...
func runLoopItem(def gate.Definition, opts *LoopOptions, backend llm.Backend, s *quest.Session, it *quest.Item, outPath, sessionPath string, out io.Writer) error {
	feedback, ruleCoach := "", ""
